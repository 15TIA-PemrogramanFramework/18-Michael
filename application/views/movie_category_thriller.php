...
<div class="row">
    <div class="col-md-12 text-right" style="margin-top:20px;margin-bottom:20px">
         <?php if( $this->session->userdata('admin') || $this->session->userdata('user') || $this->session->userdata('owner')) { echo anchor(site_url("film/add_film/".$kategori), '<i class="fa fa-plus"></i> Tambah Data', 'class="btn btn-primary"'); }?>
    </div>
</div>
<div class="row">
